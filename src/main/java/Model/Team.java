...
public class Team {
    ...
    // Constructor
    public Team(String nombre, String pais, String ciudad, String estadio, int fundacion, String entrenador,
                  String webOficial, String facebook, String twitter, String instagram, String patrocinadorPrincipal) {
        this.nombre = nombre;
        this.pais = pais;
        this.ciudad = ciudad;
